<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Tech.Master" CodeBehind="List.aspx.cs" Inherits="Exis.View.Tech.List" %>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataSourceID="SqlDataSource1" EmptyDataText="No Open Jobs Today">
        <Columns>
            ...
            <asp:TemplateField HeaderStyle-Width="275">
                <ItemTemplate>
                    <asp:LinkButton ID="lkbAssign" OnClick="lkbAssign_Click" runat="server">Assign </asp:LinkButton><asp:Label ID="lblwara" runat="server" Text=" | "></asp:Label>
                    <asp:LinkButton ID="lkbPrintJobOrder" OnClick="lkbPrintJobOrder_Click" runat="server">Print Job Order </asp:LinkButton><asp:Label ID="Label1" runat="server" Text=" | "></asp:Label>
                    <asp:LinkButton ID="lkbStart" OnClick="lkbStart_Click" runat="server" OnClientClick="return confirm('Start Job?');">Start</asp:LinkButton> <asp:Label ID="Label2" runat="server" Text=" | "></asp:Label>
...
<HeaderStyle Width="275px"></HeaderStyle>
     ...
     <asp:GridView ID="GVActive" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataSourceID="SqlDataSource2" Visible="False" EmptyDataText="All Jobs Are Done For Today">
        <Columns>
            ...
            <asp:BoundField DataField="DateScheduled" HeaderText="DateScheduled" SortExpression="DateScheduled" />
            <asp:BoundField DataField="TimeScheduled" HeaderText="TimeScheduled" SortExpression="TimeScheduled" />
            <asp:TemplateField HeaderStyle-Width="175">
                <ItemTemplate>
                    <asp:LinkButton ID="lkbJoBOrderDetails" OnClick="lkbJoBOrderDetails_Click" runat="server">Details</asp:LinkButton><asp:Label ID="Label3" runat="server" Text=" | "></asp:Label>
...
<HeaderStyle Width="175px"></HeaderStyle>
     ...
     <asp:GridView ID="GVDone" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataSourceID="SqlDataSource3" Visible="False" EmptyDataText="No Job Done For Today.">
        <Columns>
            ...
            <asp:TemplateField HeaderStyle-Width="175">
                <ItemTemplate>
                    <asp:LinkButton ID="lkbJoBOrderDetails1" OnClick="lkbJoBOrderDetails_Click" runat="server">Details</asp:LinkButton>
                </ItemTemplate>
...
<HeaderStyle Width="175px"></HeaderStyle>
     ...
     <asp:GridView ID="GVPending" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered" DataSourceID="SqlDataSource4" Visible="False" EmptyDataText="No Pending Jobs">
        <Columns>
            ...
            <asp:BoundField DataField="DateScheduled" HeaderText="DateScheduled" SortExpression="DateScheduled" />
             ...
             <asp:TemplateField>
                <ItemTemplate>
                    <asp:LinkButton ID="lkbPending" OnClick="lkbPending_Click" runat="server">Update Remarks</asp:LinkButton><asp:Label ID="lblwara" runat="server" Text=" | "></asp:Label>
         ...
         <HeaderStyle BackColor="#FF8E01" />
                ...
                <asp:TextBox ID="txtDate" placeholder="Date/Month/Year" CssClass="form form-control" runat="server" OnDataBinding="txtDate_DataBinding" Enabled="False" ReadOnly="True" Visible="False" ></asp:TextBox>
    ...
    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ExisConnectionString %>" SelectCommand="SELECT JobId, JobType, AccountNumber, Description, InstallationNotes, Technician, DateCreated, DateScheduled, Remarks, TimeScheduled FROM JobOrder WHERE (Status = @Status) AND (JobType = @JobType)">
        <SelectParameters>
    ...
    <!--start of Confirmation for Active Modal-->
    <div id="ActiveConfirmation" class="modal fade bs-example-modal-lg" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content"><div class="modal-header">Job Order Id : <asp:Label ID="lbljoborderidsetactive" runat="server" Text=""></asp:Label><button type="button" class="close" data-dismiss="modal">&times;</button>
                <div class="modal-body">
                    <div class="alert alert-warning" role="alert">This will set that the Account Number : <b><asp:Label ID="lblaccountnumbersetactive" runat="server" Text=""></asp:Label></b> will be <b>Active</b> and will start his/her <b>Billing Cycle</b>. Click Submit to Confirm.</div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <asp:Button ID="btnSubmitActive" CssClass="btn btn-primary" runat="server" OnClick="btnSubmitActive_Click" Text="Submit" />
                </div>
            </div>
        </div>
    </div>
    ...
    <!--start of Succesfully Reschedule Modal-->
    <div id="SuccessReschedule" class="modal fade bs-example-modal-lg" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content"><div class="modal-header">Success<button type="button" class="close" data-dismiss="modal">&times;</button>
                <div class="modal-body">
                    <div class="alert alert-success" role="alert"><b>Well Done</b> You successfully Rescheduled Job Order.</div>
                </div>
            </div>
        </div>
    </div>
    </div>
    <!--end of Succesfully Reschedule Modal-->

    <!--start of detail modal-->
    <div id="Detail" class="modal fade bs-example-modal-sm" role="dialog">
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">Detail<button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                     <table class="nav-justified">
        <tr>
            <td class="datepicker-inline" style="width: 198px">Job ID :
                <asp:Label ID="lbldetjobid" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="datepicker-inline" style="width: 198px">Job Type :
                <asp:Label ID="lbldetjobtype" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="datepicker-inline" style="width: 198px; height: 15px;">Account Number :
                <asp:Label ID="lbldetaccountnumber" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="datepicker-inline" style="width: 198px">Service Plan :
                <asp:Label ID="lbldetserviceplan" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="datepicker-inline" style="width: 198px">Address :
                <asp:Label ID="lbldetaddress" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="datepicker-inline" style="width: 198px">Description :
                <asp:TextBox ID="txtdetdescription" CssClass="form form-control" runat="server" TextMode="MultiLine" Height="74px" Width="253px"></asp:TextBox>
                </td>
        </tr>
        <tr>
            <td class="datepicker-inline" style="width: 198px">&nbsp;</td>
        ...
        <tr>
            <td class="datepicker-inline" style="width: 198px">Installation Notes :
                </td>
        </tr>
        <tr>
            <td class="datepicker-inline" style="width: 198px">
                <asp:TextBox ID="txtdetinstallationnotes" CssClass="form form-control" runat="server" TextMode="MultiLine" Height="74px" Width="253px"></asp:TextBox>
                </td>
        </tr>
        <tr>
            <td class="datepicker-inline" style="width: 198px"><br />
