...
{
    public partial class ListForDisconnection : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //badge for open
            var copen = db.CountBadgeForRepairAndOpenFromJobOrder("Open", "For Disconnection");
            ...
            var cinprog = db.CountBadgeForRepairAndOpenFromJobOrder("In Progress", "For Disconnection");
            ...
            var cpend = db.CountBadgeForRepairAndOpenFromJobOrder("Pending", "For Disconnection");
            ...
            //badge for in done
            var cdone = db.CountBadgeForRepairAndOpenFromJobOrder("Done", "For Disconnection");
        ...
        public void refreshgridviews()
        {
            ...
            GVDone.DataBind();
            GVPending.DataBind();
            Response.Redirect("~/View/Tech/ListForDisconnection");
        }
        ...
        protected void lkbStart_Click(object sender, EventArgs e)
        {
            LinkButton btn = (LinkButton)sender;
            GridViewRow gvr = (GridViewRow)btn.NamingContainer;
            if (gvr.Cells[4].Text == "Not Yet Assigned")
            {
        ...
        protected void lkbDoneJob_Click(object sender, EventArgs e)
        {
            ...
            db.UpdateCustomerDisconnected(gvr.Cells[2].Text);
