<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Tech.Master" CodeBehind="ListForDisconnection.aspx.cs" Inherits="Exis.View.Tech.ListForDisconnection" %>
    ...
    <table class="nav-justified">
        ...
        <tr>
            <td style="height: 41px">
                  <asp:LinkButton ID="btnOpen" CssClass="btn btn-default" role="Button" runat="server" OnClick="btnOpen_Click">Open <span id="spnMyReq" runat="server" class="badge"></span></asp:LinkButton>
                  ...
                  <asp:LinkButton ID="btnPending" CssClass="btn btn-danger" role="Button" runat="server" OnClick="btnPending_Click">Pending <span id="spnPending" runat="server" class="badge"></span></asp:LinkButton>
