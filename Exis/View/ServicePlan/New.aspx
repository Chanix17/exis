<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Administrator.Master" CodeBehind="New.aspx.cs" Inherits="Exis.View.ServicePlan.New" %>
...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
       <table class="nav-justified">
        ...
        <tr>
            ...
            <td style="height: 66px; width: 406px;">
                <asp:TextBox ID="txtdescription" CssClass="form form-control" runat="server" Height="67px" TextMode="MultiLine" Width="231px"></asp:TextBox>
            </td>
            <td style="height: 66px">
                &nbsp;</td>
        </tr>
